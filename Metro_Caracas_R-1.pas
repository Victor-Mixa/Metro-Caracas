...
CI,A,B,C,D,E,F,G,H,I,J,tipos,Num,Viajes,line: integer;
//INICIO DEL CODIGO//
...
2: writeln('Usted tiene un viaje en metro, un viaje en microbus');
3:writeln ('Usted tiene 2 viajes en metro');
4:writeln ('Usted tiene 2 viajes en metro, 2 viajes en microbus');
5:writeln ('Usted tiene 10 viajes en metro');
6:writeln ('Usted tiene 10 viajes en metro, 10 viajes en microbus');
...
Readln(Line);
	case Line of
		...
		5:WriteLn('Bello Monte, Las Mercedes, Parque Simón Bolívar, Bello Campo, Hugo Chávez, Monte Cristo, Boleita, El Marquéz, Warairarepano');
		6:WriteLn('Zoológico,La Riconada');
